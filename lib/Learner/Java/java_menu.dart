...
final List<Map<String, dynamic>> items = java;



class JavaMenu extends StatefulWidget {
  const JavaMenu({super.key});

  @override
  State<JavaMenu> createState() => _JavaMenuState();
}

class _JavaMenuState extends State<JavaMenu> {
  int completedItems = 0; // A state variable to store the count
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: bg,
      appBar: AppBar(
        title: Text("Java", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: height*0.03)),
